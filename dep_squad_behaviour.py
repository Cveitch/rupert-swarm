...
#
#
# KEEP JUST IN CASE, BUT USE SQUAD_CONTROL INSTEAD
...
#     global range_floor
#     global in_formation
#     # Mac 0 doesn't move, it's at the top of the triangle.
#     if mac_num == 0:
#         drive(stop, 0)
#     # Mac 1 attempts to get in range of Mac 0.
#     elif mac_num == 1 and (dist_c < range_floor or dist_c > range_ceiling):
#         turn(right, fortyfive)
#         drive(forw, 0.5)
#     # Mac 2 attempts to get in range of Mac 0 and Mac 1.
...
# # This is in reference to the points a, b, and c around an equilateral triangle.
