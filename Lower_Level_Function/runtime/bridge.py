...
class Bridge:
	...
	def request ( self, request ):
		...
		try:
			...
			raise BridgeError( "Bridge communication failed( device={}, speed={} bps".format( self.serial_device, self.baudrate ) ) from e
		except:
			raise BridgeError( "Unknown Error in Bridge" )
